...
class AnalisisCV(BaseModel):
    ...
    experiencia_años: int = Field(description="Años totales de experiencia laboral relevante del candidato.")
    ...
    areas_mejora: list[str] = Field(description="2-4 áreas donde el candidato podria desarrollarse o mejorar.")
